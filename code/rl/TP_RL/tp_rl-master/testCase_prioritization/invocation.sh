...
do
    # for ACER-PA
    # python TPDRL.py -m pairwise -a acer -d enriched -e 200 -w 4 -t ../data/real_new/${dataset} -o ../experiments/normal
    # for PPO2-PO
    python TPDRL.py -m pointwise -a ppo2 -d enriched -e 200 -w 4 -t ../data/real_new/${dataset} -o ../experiments/normal
    # for PPO1-LI
    # python TPDRL.py -m listwise -a ppo1 -d enriched -e 200 -w 4 -t ../data/real_new/${dataset} -o ../experiments/normal
