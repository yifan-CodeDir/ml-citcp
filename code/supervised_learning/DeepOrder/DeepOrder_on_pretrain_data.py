...
if __name__ == '__main__':
    ...
    # training_sample_list = [1998, 2010, 2008, 2005, 3001, 3007, 1999, 2044, 2017, 2011]
    ...
    for project in projects:
        ...
        # ### Deep Neural Network 
        spilt = 19833    #  it's the number of test cases for nfe project
        ...
        for index in range (1, Last_cycle+1):
            ...
            if (cycle_num <= Last_cycle and cycle_num in df['Cycle']):
                ...
                final_df_temp.to_csv('./result/pretrain/' + project + '_detail.csv',
                                    header=True, mode='a',
                                    index=False)  ################
        ...
        output.to_csv('./result/pretrain/'+ project +'.csv', mode='a', sep=";",header=True, index = False) ############
