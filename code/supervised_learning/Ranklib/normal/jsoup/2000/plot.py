...
x = range(len(fm_dict['ranker0'])-interval)
y1 = rolling(fm_dict['ranker0'])
y2 = rolling(fm_dict['ranker1'])
y3 = rolling(fm_dict['ranker2'])
y4 = rolling(fm_dict['ranker4'])
y5 = rolling(fm_dict['ranker6'])
